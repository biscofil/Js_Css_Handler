...
class Jscsshandler {
    ...
    public static function setJsProperty(string $name, $value) {
    ...
    public static function addJsFile(string $path, $params = null) {
        self::$js_files[] = ['url' => $path, 'params' => $params];
    }

    public static function addCssFile(string $path, $params = ['rel' => 'stylesheet']) {
        self::$css_files[] = ['url' => $path, 'params' => $params];
    }
